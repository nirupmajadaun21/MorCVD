...
<asp:Content ID="ContentPlaceHolder" ContentPlaceHolderID="ContentPlaceHolder_navigation" runat="server">
    ...
    <li class="active" style="font-weight: bold;">
        ...
        <li class="active" style="font-weight: bold;">
            ...
            <asp:LinkButton ID="LinkButton_Disease" runat="server" OnClick="LinkButton_Disease_Click">Disease</asp:LinkButton>

        </li>

        <li class="active" style="font-weight: bold;">
            <asp:LinkButton ID="LinkButton_Pathogen" runat="server" OnClick="LinkButton_Pathogen_Click">Pathogen Specific Interactions</asp:LinkButton>

        </li>

        <li class="active" style="font-weight: bold;">
            <asp:LinkButton ID="LinkButton_Protein" runat="server" OnClick="LinkButton_Protein_Click">Protein Specific Interactions</asp:LinkButton>

        </li>

        <li class="active" style="font-weight: bold;">
            <asp:LinkButton ID="LinkButton_Gene" runat="server" OnClick="LinkButton_Gene_Click">Gene Ontologies</asp:LinkButton>
...
<asp:LinkButton ID="LinkButton_Interactors" runat="server" OnClick="LinkButton_Interactors_Click">Interactors & Drug Targets</asp:LinkButton></li>-->
        ...
        <style>
            ...
            /*.dropdown:hover .dropbtn {background-color: #3e8e41;}*/
                ...
                <div class="dropdown">
            <button class="dropbtn" style="font-weight: bold;">Interaction Detection Methods</button>
            <div class="dropdown-content">

                <ul class="nav navbar-nav dropdown-content">

        <li class="active" style="font-weight: bold;">
            <asp:LinkButton ID="LinkButton_Interaction_Methods" runat="server" OnClick="LinkButton_Interaction_Methods_Click">Interaction Detection Method</asp:LinkButton>

        </li>

                    <li class="active" style="font-weight: bold;">
                        <asp:LinkButton ID="LinkButton_Multiple_Methods" runat="server" align="left" OnClick="LinkButton_Multiple_Methods_Click">Multiple Methods</asp:LinkButton>
                    </li>
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                ...
                <ul class="nav navbar-nav dropdown-content">
                    ...
                    <li class="active" style="font-weight: bold;">
                        <asp:LinkButton ID="LinkButton_test" runat="server" OnClick="LinkButton_test_Click">Interactors</asp:LinkButton>
                    </li>

                    <li class="active" style="font-weight: bold;">
                        <asp:LinkButton ID="LinkButton_common_int" runat="server" align="left" OnClick="LinkButton_common_int_Click">Common Interactors</asp:LinkButton>
                    </li>
        ...
        <asp:View ID="disease" runat="server">
                    ...
                    <table>
                        <td>
                            <asp:DropDownList ID="disease_drop" runat="server" CssClass="dropdown-toggle btn-lg">
                                ...
                                <asp:ListItem Value="Dilated Cardiomyopathy">Dilated Cardiomyopathy</asp:ListItem>
                                <asp:ListItem Value="Pericarditis">Pericarditis</asp:ListItem>
                                <asp:ListItem Value="Viral Myocarditis">Viral Myocarditis</asp:ListItem>
                                <asp:ListItem Value="Cardiovascular Infections">Cardiovascular Infections</asp:ListItem>
                                <asp:ListItem Value="Acute Myocarditis">Acute Myocarditis</asp:ListItem>
                                <asp:ListItem Value="Myocarditis">Myocarditis</asp:ListItem>
                                <asp:ListItem Value="Hypereosinophilic Syndrome">Hypereosinophilic Syndrome</asp:ListItem>
                                <asp:ListItem Value="Endocarditis">Endocarditis</asp:ListItem>
                                <asp:ListItem Value="Bacterial Endocarditis">Bacterial Endocarditis</asp:ListItem>
                                <asp:ListItem Value="Infective Endocarditis">Infective Endocarditis</asp:ListItem>
                                <asp:ListItem Value="Peripartum Cardiomyopathy">Peripartum Cardiomyopathy</asp:ListItem>
                                <asp:ListItem Value="Q-fever Endocarditis">Q-fever Endocarditis</asp:ListItem>
                                <asp:ListItem Value="Viral Cardiomyopathy">Viral Cardiomyopathy</asp:ListItem>
                                <asp:ListItem Value="Native Valve Endocarditis">Native Valve Endocarditis</asp:ListItem>
                                <asp:ListItem Value="Endocarditis of Mitral Valve">Endocarditis of Mitral Valve</asp:ListItem>
                                <asp:ListItem Value="Camptodactyly-Arthropathy-Coxa Vara-Pericarditis Syndrome">Camptodactyly-Arthropathy-Coxa Vara-Pericarditis Syndrome</asp:ListItem>
                                <asp:ListItem Value="Staphylococcus aureus Endocarditis">Staphylococcus aureus Endocarditis</asp:ListItem>
                                <asp:ListItem Value="Chronic Myocarditis">Chronic Myocarditis</asp:ListItem>
                                <asp:ListItem Value="Subacute Bacterial Endocarditis">Subacute Bacterial Endocarditis</asp:ListItem>
            ...
            <div class="row text-center">
                ...
                <div class="col-md-offset-1 col-md-10" style="font-size: x-large;">
                    ...
                    <div id="div_disease_download_data" runat="server" style="float: right; font-weight: bold;" visible="false">
                        <div class="row">
                            <h4 style="font-weight: bold;">Search by Protein IDs</h4>
                        <asp:TextBox ID="disease_search_box" CssClass="form-control" runat="server" ></asp:TextBox>
                        <asp:Button ID="disease_search_button" runat="server" Text="Submit" CssClass="btn-success btn-lg" OnClick="disease_search_button_Click" />     
                        </div>
                       <br />
                        <asp:Button ID="download_data" CssClass="btn-sm btn-warning" OnClick="download_data_Click" runat="server" Text="Download" />
                    </div>
                    <asp:GridView OnRowDataBound="disease_gridview_DataBound" CssClass="gridview" ID="disease_gridview" runat="server" Width="100%" CellPadding="4"
                        ShowHeaderWhenEmpty="false" ForeColor="Transparent" AllowPaging="true" AllowSorting="true"
                        PageSize="100" OnPageIndexChanging="disease_gridview_PageIndexChanging"
                        OnSorting="disease_gridview_Sorting"
                        BorderColor="Black" BorderWidth="2px" PageScroll="Both" HeaderStyle-Width="100px">
                        ...
                        <HeaderStyle BackColor="#EB6534" Font-Bold="True" ForeColor="Black" Font-Size="Medium" Width="10%" />
                        <PagerStyle BackColor="#EB6534" ForeColor="White" HorizontalAlign="Center" />
        ...
        <asp:View ID="pathogen_specific_interactions" runat="server">
            ...
            <div class="row">
                ...
                <div class="col-md-offset-1 col-md-10" style="font-size: large;">
                    <div id="div_pathogen_specific_download_data" runat="server" style="float: right; font-weight: bold;" visible="false">
                        <asp:Button ID="pathogen_specific_download_data" CssClass="btn-sm btn-warning" OnClick="pathogen_specific_download_data_Click" runat="server" Text="Download" />
                    </div>
                    <asp:GridView CssClass="gridview" OnRowDataBound="pathogen_specific_gridview_RowDataBound" ID="pathogen_specific_gridview" runat="server" Width="100%" 
                        CellPadding="4" PageSize="100" ForeColor="#333333" GridLines="Both" 
                        AllowPaging="true" OnPageIndexChanging="pathogen_specific_gridview_PageIndexChanging" 
                        BorderColor="Black" BorderWidth="2px" HorizontalAlign="Left" ShowHeaderWhenEmpty="false">
                        <AlternatingRowStyle BackColor="Transparent" ForeColor="Black" Font-Size="Medium" />
                        <EditRowStyle BackColor="Transparent" Font-Size="Medium" />
                        <FooterStyle BackColor="Transparent" Font-Bold="True" ForeColor="White" Font-Size="Small" />
                        <HeaderStyle BackColor="#EB6534" Font-Bold="True" ForeColor="Black" Font-Size="Medium" Width="10%" />
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <table style="width: 100%" class="text-center">
                        <tr>
                            <th style="font-size: x-large;">Host Organism
                            </th>
                ...
                <asp:MultiView ID="MultiView2" runat="server">
                    ...
                    <asp:View ID="human_host_view" runat="server">
                            ...
                            <div class="col-md-4">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p style="color: black;">Provide Uniprot Accession Number (Example: Q13509) </p>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                        ...
                        <div class="row text-center">
                            ...
                            <div class="col-md-offset-1 col-md-10" style="font-size: large;">
                                <div id="div_protein_specific_human_download_data" runat="server" style="float: right; font-weight: bold;" visible="false">
                        <asp:Button ID="protein_specific_human_download_data" CssClass="btn-sm btn-warning" OnClick="protein_specific_human_download_data_Click" runat="server" Text="Download" />
                                   </div>
                                <asp:GridView CssClass="gridview" OnRowDataBound="protein_pathogen_specific_gridview_RowDataBound" ID="protein_pathogen_specific_gridview" runat="server" Width="100%"
                                    CellPadding="4" Caption="* For Degree 1, 2, and 3 please refer to documentation" ForeColor="Black" GridLines="Both" PageSize="100" AllowPaging="true" ShowHeaderWhenEmpty="false" OnPageIndexChanging="protein_pathogen_specific_gridview_PageIndexChanged" BorderColor="Black" BorderWidth="2px" HorizontalAlign="Left">
                                    <AlternatingRowStyle CssClass="gridview" BackColor="Transparent" ForeColor="Black" HorizontalAlign="left" />
                    ...
                    <asp:View ID="protein_pathogen" runat="server">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            <p style="color: black;">Select pathogen & provide Uniprot Accession Number (Example: Vaccinia virus WR, P21605) </p>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                        ...
                        <div class="row text-center">
                            <div class="col-md-offset-1 col-md-10" style="font-size: large;">
                                  <div id="div_protein_specific_download_data" runat="server" style="float: right; font-weight: bold;" visible="false">
                        <asp:Button ID="protein_specific_download_data" CssClass="btn-sm btn-warning" OnClick="protein_specific_download_data_Click" runat="server" Text="Download" />
                                   </div>
                                <asp:GridView CssClass="gridview" OnRowDataBound="protein_specific_gridview_RowDataBound" ID="protein_specific_gridview" runat="server" CellPadding="4" ForeColor="#333333" 
                                    GridLines="Both" Caption="* For Degree 1, 2, and 3 please refer to documentation" Width="100%" 
                                    BorderColor="Black" BorderWidth="2px" HorizontalAlign="Center" ShowHeaderWhenEmpty="false" 
                                    AllowPaging="true" PageSize="100" OnPageIndexChanging="protein_specific_gridview_PageIndexChanging">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <table>
                        <tr>
                            <th>
                                <asp:DropDownList ID="gene_ontologies_drop" runat="server" CssClass="btn-lg dropdown-toggle" AutoPostBack="True" OnSelectedIndexChanged="gene_ontologies_drop_SelectedIndexChanged">
                                    <asp:ListItem>Select</asp:ListItem>
                                    <asp:ListItem Value="HOST_PROTEIN">Human</asp:ListItem>
                                    <asp:ListItem Value="PATHOGEN_PROTEIN">Pathogen</asp:ListItem>
                                </asp:DropDownList></th>
            ...
            <div class="row">
                <asp:MultiView ID="MultiView3" runat="server">
                    ...
                    <asp:View ID="human_protein" runat="server">
                        ...
                        <div class="row text-center">
                            <div class="col-md-offset-1 col-md-10" style="font-size: large;">
                             <div id="div_gene_ontologies_human_download_data" runat="server" style="float: right; font-weight: bold;" visible="false">
                        <asp:Button ID="gene_ontologies_human_download_data" CssClass="btn-sm btn-warning" OnClick="gene_ontologies_human_download_data_Click" runat="server" Text="Download" />
                                   </div>

                                <asp:GridView CssClass="gridview" ID="gene_ontologies_human_uniprot_gridview" runat="server" 
                                    Width="100%" CellPadding="4" ForeColor="#333333" BorderColor="Black" BorderWidth="2px" 
                                    HorizontalAlign="Left" GridLines="Both" ShowHeaderWhenEmpty="false" AllowPaging="true" 
                                    PageSize="100" OnRowDataBound="gene_ontologies_human_uniprot_gridview_RowDataBound" OnPageIndexChanging="gene_ontologies_human_uniprot_gridview_PageIndexChanging1">
...
<asp:DropDownList ID="gene_ontology_pathogen_drop" runat="server"></asp:DropDownList></th>
                            ...
                            <div class="col-md-4">
                                <table style="font-size: large;">
                                    <tr>
                                        ...
                                        <tr>
                                            <td>Provide Uniprot Accession Number (Example: P21605)</td>
                                        </tr>
                                    </tr>
                                </table>
                            </div>
                        ...
                        <div class="row text-center">
                            <div class="col-md-offset-1 col-md-10" style="font-size: large;">
                          <div id="div_gene_ontologies_pathogen_download_data" runat="server" style="float: right; font-weight: bold;" visible="false">
                        <asp:Button ID="gene_ontologies_pathogen_download_data" CssClass="btn-sm btn-warning" OnClick="gene_ontologies_pathogen_download_data_Click" runat="server" Text="Download" />
                                   </div>
                                <table style="width: 100%">
                                    <asp:GridView CssClass="gridview" ID="gene_ontology_pathogen_protein_gridview" runat="server" 
                                        Width="100%" CellPadding="4" ForeColor="#333333" BorderColor="Black" BorderWidth="2px" 
                                        HorizontalAlign="Left" GridLines="Both" OnRowDataBound="gene_ontology_pathogen_protein_gridview_RowDataBound" ShowHeaderWhenEmpty="false" AllowPaging="true" 
                                        PageSize="100" OnPageIndexChanging="gene_ontology_pathogen_protein_gridview_PageIndexChanging1">
                                <AlternatingRowStyle BackColor="Transparent" ForeColor="Black" Font-Size="Medium" />
                                <EditRowStyle BackColor="Transparent" Font-Size="Medium" />
                                <FooterStyle BackColor="Transparent" Font-Bold="True" ForeColor="White" Font-Size="Small" />
                                <HeaderStyle BackColor="#EB6534" Font-Bold="True" ForeColor="Black" Font-Size="Medium" Width="10%" />
        ...
        <asp:View ID="interaction_multiple_method" runat="server">
                                    <div class="row text-capitalize text-center">
                <p>
                    <br />
                    <br />
                </p>
                <h2 style="font-weight: bold; font-family: 'Roboto Slab', serif;">INTERACTIONS DETECTED BY MULTIPLE METHODS</h2>
            </div>
                        <div class="clearfix">
                <p>
                    <br />
                ...
                <div class="col-md-4">
                    <table style="font-size: large;">
                        <tr>
                            <th>
                                <asp:DropDownList ID="interaction_detection_multiple_method_drop" runat="server" OnSelectedIndexChanged="interaction_detection_multiple_method_drop_SelectedIndexChanged1" CssClass="btn-lg dropdown-toggle">
                                    <asp:ListItem Value="-">Select</asp:ListItem>
            ...
            <div class="row text-center">
                <asp:Button ID="interaction_detection_multiple_method_submit" CssClass="btn-success btn-lg text-center" runat="server" Text="Submit" OnClick="interaction_detection_multiple_method_submit_Click" />
            </div>
            <div class="row">
                <p>
                    <br />
                   ...
                   <div class="col-md-offset-1 col-md-10" style="font-size: x-large;">
                <p>
                    <asp:GridView CssClass="gridview" OnRowDataBound="interaction_multiple_method_gridview_RowDataBound" ID="interaction_multiple_method_gridview" Width="100%" CellPadding="4" runat="server" 
                        ForeColor="Transparent" BorderColor="Black" BorderWidth="2px" GridLines="Both" AllowPaging="true" 
                        PageSize="100" ShowHeaderWhenEmpty="false" OnPageIndexChanging="interaction_multiple_method_gridview_PageIndexChanging1">
                                <AlternatingRowStyle BackColor="Transparent" ForeColor="Black" Font-Size="Medium"/>
                                <EditRowStyle BackColor="Transparent" Font-Size="Medium" />
                                <FooterStyle BackColor="Transparent" Font-Bold="True" ForeColor="White" Font-Size="Small" />
                                <HeaderStyle BackColor="#EB6534" Font-Bold="True" HorizontalAlign="Center" ForeColor="Black" Font-Size="Medium" Width="10%" />
                                <PagerStyle HorizontalAlign="Center" BackColor="#EB6534" ForeColor="White" />
                                <RowStyle BackColor="Transparent" ForeColor="Black" Font-Size="Medium" />
                                <SelectedRowStyle BackColor="#E2DED6" Font-Bold="True" ForeColor="#333333" />
                                <SortedAscendingCellStyle BackColor="#E9E7E2" />
                                <SortedAscendingHeaderStyle BackColor="#506C8C" />
        ...
        <asp:View ID="interaction_detection_method" runat="server">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <table style="font-size: large;">
                        <tr>
                            <th>
                                <asp:DropDownList ID="interaction_detection_method_drop" runat="server" OnSelectedIndexChanged="interaction_detection_method_drop_SelectedIndexChanged" CssClass="btn-lg dropdown-toggle">
                                    <asp:ListItem>Select</asp:ListItem>
                                </asp:DropDownList></th>
                        </tr>
                    </table>
            ...
            <div class="row text-center">
                <div class="col-md-offset-1 col-md-10" style="font-size: large;">
                       <div id="div_interaction_detection_download_data" runat="server" style="float: right; font-weight: bold;" visible="false">
                        <asp:Button ID="interaction_detection_download_data" CssClass="btn-sm btn-warning" OnClick="interaction_detection_download_data_Click" runat="server" Text="Download" />
                        </div>
                    <asp:GridView CssClass="gridview" OnRowDataBound="interaction_detection_method_gridview_RowDataBound" ID="interaction_detection_method_gridview" Width="100%" CellPadding="4" runat="server" 
                        ForeColor="Transparent" BorderColor="Black" BorderWidth="2px" GridLines="Both" AllowPaging="true" 
                        PageSize="100" OnPageIndexChanging="interaction_detection_method_gridview_PageIndexChanged" ShowHeaderWhenEmpty="false">
                                <AlternatingRowStyle BackColor="Transparent" ForeColor="Black" Font-Size="Medium" />
                                <EditRowStyle BackColor="Transparent" Font-Size="Medium" />
                                <FooterStyle BackColor="Transparent" Font-Bold="True" ForeColor="White" Font-Size="Small" />
                                <HeaderStyle BackColor="#EB6534" Font-Bold="True" HorizontalAlign="Center" ForeColor="Black" Font-Size="Medium" Width="10%" />
        ...
        <asp:View ID="interactors" runat="server">
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-11">
                                <table style="width: 100%; font-size: large;">
                                    ...
                                    <tr>
                                        <td></td>
                                        <td style="font-size: small;">Provide Uniprot Accession Number (Example: P21605)</td>
                                    </tr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-11">
                                <table style="width: 100%; font-size: large;">
                                    ...
                                    <tr>
                                        <td></td>
                                        <td style="font-size: small;">Provide Uniprot Accession Number (Example: Q13509)</td>
                                    </tr>
                    ...
                    <div class="row text-center">
                   <div id="div_interactors_human_download_data" runat="server" style="float: right; font-weight: bold;" visible="false">
                        <asp:Button ID="interactors_human_download_data" CssClass="btn-sm btn-warning" OnClick="interactors_human_download_data_Click" runat="server" Text="Download Data" />
                         </div>
             
                        <div class="col-md-12" style="font-size: large;">
                            <asp:GridView ID="GridView2" CssClass="gridview" Width="95%" CellPadding="4" runat="server" ForeColor="Transparent" BorderColor="Black" BorderWidth="2px" GridLines="Both" AllowPaging="true" PageSize="100" OnPageIndexChanging="GridView2_PageIndexChanging" ShowHeaderWhenEmpty="false">
                                <AlternatingRowStyle BackColor="Transparent" ForeColor="Black" Font-Size="Medium" />
                                <EditRowStyle BackColor="Transparent" Font-Size="Medium" />
                                <FooterStyle BackColor="Transparent" Font-Bold="True" ForeColor="White" Font-Size="Small" />
                                <HeaderStyle BackColor="#EB6534" Font-Bold="True" HorizontalAlign="Center" ForeColor="Black" Font-Size="Medium" Width="10%" />
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-md-12" style="font-size: large;">
                            ...
                            <asp:GridView ID="GridView3" Width="95%" CssClass="gridview" CellPadding="4" runat="server" ForeColor="Transparent" BorderColor="Black" BorderWidth="2px" GridLines="Both" AllowPaging="true" PageSize="100" OnPageIndexChanging="GridView3_PageIndexChanging" ShowHeaderWhenEmpty="false">
                                <AlternatingRowStyle BackColor="Transparent" ForeColor="Black" Font-Size="Medium" />
                                <EditRowStyle BackColor="Transparent" Font-Size="Medium" />
                                <FooterStyle BackColor="Transparent" Font-Bold="True" ForeColor="White" Font-Size="Small" />
                                <HeaderStyle BackColor="#EB6534" Font-Bold="True" HorizontalAlign="Center" ForeColor="Black" Font-Size="Medium" Width="10%" />
                    ...
                    <div class="row text-center">
                        <div class="col-md-12" style="font-size: large;">
                            ...
                            <asp:GridView ID="interactors_pathogen_gridview" CssClass="gridview" Width="95%" CellPadding="4" runat="server" ForeColor="Transparent" BorderColor="Black" BorderWidth="2px" GridLines="Both" AllowPaging="true" PageSize="100" OnPageIndexChanging="interactors_pathogen_gridview_PageIndexChanging">
                                <AlternatingRowStyle BackColor="Transparent" ForeColor="Black" Font-Size="Medium" />
                                <EditRowStyle BackColor="Transparent" Font-Size="Medium" />
                                <FooterStyle BackColor="Transparent" Font-Bold="True" ForeColor="White" Font-Size="Small" />
                                <HeaderStyle BackColor="#EB6534" Font-Bold="True" HorizontalAlign="Center" ForeColor="Black" Font-Size="Medium" Width="10%" />
                    ...
                    <div class="row text-center">
                        <div class="col-md-12" style="font-size: large;">
                            <asp:GridView ID="GridView1" runat="server" CssClass="gridview" Width="95%" CellPadding="4" ForeColor="Transparent" BorderColor="Black" BorderWidth="2px" GridLines="Both" AllowPaging="true" PageSize="100" OnPageIndexChanging="GridView1_PageIndexChanging">
                                <AlternatingRowStyle BackColor="Transparent" ForeColor="Black" Font-Size="Medium" />
                                <EditRowStyle BackColor="Transparent" Font-Size="Medium" />
                                <FooterStyle BackColor="Transparent" Font-Bold="True" ForeColor="White" Font-Size="Small" />
                                <HeaderStyle BackColor="#EB6534" Font-Bold="True" HorizontalAlign="Center" ForeColor="Black" Font-Size="Medium" Width="10%" />
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <table>
                        <tr>
                            <th>
                                <asp:DropDownList ID="test_drop" runat="server" CssClass="btn-lg dropdown-toggle" AutoPostBack="True" OnSelectedIndexChanged="test_drop_SelectedIndexChanged">
                                    <asp:ListItem>Select</asp:ListItem>
                                    <asp:ListItem Value="HOST_PROTEIN">Human</asp:ListItem>
                                    <asp:ListItem Value="PATHOGEN_PROTEIN">Pathogen</asp:ListItem>
                                </asp:DropDownList></th>
            ...
            <div class="row">
                <asp:MultiView ID="test_multiview" runat="server">
                    ...
                    <asp:View ID="test_human_view" runat="server">
                        ...
                        <div class="row text-center">
                            <div class="col-md-offset-1 col-md-10" style="font-size: large;">
                                <asp:GridView ID="test_human_gridview" CssClass="gridview" OnRowDataBound="test_human_gridview_RowDataBound" runat="server" Width="100%" CellPadding="4" ForeColor="#333333" BorderColor="Black" BorderWidth="2px" HorizontalAlign="Left" GridLines="Both" ShowHeaderWhenEmpty="false" AllowPaging="true" PageSize="100" OnPageIndexChanging="test_human_gridview_PageIndexChanging">
                                <AlternatingRowStyle BackColor="Transparent" ForeColor="Black" Font-Size="Medium" />
                                <EditRowStyle BackColor="Transparent" Font-Size="Medium" />
                                <FooterStyle BackColor="Transparent" Font-Bold="True" ForeColor="White" Font-Size="Small" />
                                <HeaderStyle BackColor="#EB6534" Font-Bold="True" HorizontalAlign="Center" ForeColor="Black" Font-Size="Medium" Width="10%" />
                        ...
                        <div class="row text-center">
                            <div class="col-md-offset-1 col-md-10" style="font-size: large;">
                                <asp:GridView ID="test_human_gridview_2" runat="server" CssClass="gridview" OnRowDataBound="test_human_gridview_2_RowDataBound" Width="100%" CellPadding="4" ForeColor="#333333" BorderColor="Black" BorderWidth="2px" HorizontalAlign="Left" GridLines="Both" ShowHeaderWhenEmpty="false" AllowPaging="true" PageSize="100" OnPageIndexChanging="test_human_gridview_2_PageIndexChanging">
                                <AlternatingRowStyle BackColor="Transparent" ForeColor="Black" Font-Size="Medium" />
                                <EditRowStyle BackColor="Transparent" Font-Size="Medium" />
                                <FooterStyle BackColor="Transparent" Font-Bold="True" ForeColor="White" Font-Size="Small" />
                                <HeaderStyle BackColor="#EB6534" Font-Bold="True" HorizontalAlign="Center" ForeColor="Black" Font-Size="Medium" Width="10%" />
                    ...
                    <asp:View ID="test_pathogen_view" runat="server">
                        ...
                        <div class="row text-center">
                            <div class="col-md-offset-1 col-md-10" style="font-size: large;">
                                <table style="width: 100%">
                                    <asp:GridView ID="test_pathogen_gridview" CssClass="gridview" OnRowDataBound="test_pathogen_gridview_RowDataBound" runat="server" Width="100%" CellPadding="4" ForeColor="#333333" BorderColor="Black" BorderWidth="2px" HorizontalAlign="Left" GridLines="Both" ShowHeaderWhenEmpty="false" AllowPaging="true" PageSize="100" OnPageIndexChanging="gene_ontology_pathogen_protein_gridview_PageIndexChanging1">
                                <AlternatingRowStyle BackColor="Transparent" ForeColor="Black" Font-Size="Medium" />
                                <EditRowStyle BackColor="Transparent" Font-Size="Medium" />
                                <FooterStyle BackColor="Transparent" Font-Bold="True" ForeColor="White" Font-Size="Small" />
                                <HeaderStyle BackColor="#EB6534" Font-Bold="True" HorizontalAlign="Center" ForeColor="Black" Font-Size="Medium" Width="10%" />
                        ...
                        <div class="row text-center">
                            <div class="col-md-offset-1 col-md-10" style="font-size: large;">
                                <table style="width: 100%">
                                    <asp:GridView CssClass="gridview" ID="test_pathogen_gridview_2" OnRowDataBound="test_pathogen_gridview_2_RowDataBound" runat="server" Width="100%" CellPadding="4" ForeColor="#333333" BorderColor="Black" BorderWidth="2px" HorizontalAlign="Left" GridLines="Both" ShowHeaderWhenEmpty="false" AllowPaging="true" PageSize="100" OnPageIndexChanging="test_pathogen_gridview_2_PageIndexChanging">
                                <AlternatingRowStyle BackColor="Transparent" ForeColor="Black" Font-Size="Medium" />
                                <EditRowStyle BackColor="Transparent" Font-Size="Medium" />
                                <FooterStyle BackColor="Transparent" Font-Bold="True" ForeColor="White" Font-Size="Small" />
                                <HeaderStyle BackColor="#EB6534" Font-Bold="True" HorizontalAlign="Center" ForeColor="Black" Font-Size="Medium" Width="10%" />
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <table>
                        <tr>
                            <th>
                                <asp:DropDownList ID="common_drop" runat="server" CssClass="btn-lg dropdown-toggle" AutoPostBack="True" OnSelectedIndexChanged="common_drop_SelectedIndexChanged">
                                    <asp:ListItem>Select</asp:ListItem>
                                    <asp:ListItem Value="HOST_PROTEIN">Human</asp:ListItem>
                                    <asp:ListItem Value="PATHOGEN_PROTEIN">Pathogen</asp:ListItem>
                                </asp:DropDownList></th>
                    ...
                    <asp:View ID="common_human_view" runat="server">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <table>
                                    <tr>
                                        <td>Provide Uniprot Accession Numbers(Example: Q71U36 & P04150)</td>
                                    </tr>
                                </table>
                            </div>
                        ...
                        <div class="row text-center">
                            <div class="col-md-offset-1 col-md-10" style="font-size: large;">
                                <asp:GridView CssClass="gridview" ID="common_human_gridview" OnRowDataBound="common_human_gridview_RowDataBound" runat="server" Width="100%" CellPadding="4" ForeColor="#333333" BorderColor="Black" BorderWidth="2px" HorizontalAlign="Left" GridLines="Both" ShowHeaderWhenEmpty="false" AllowPaging="true" PageSize="100" OnPageIndexChanging="common_human_gridview_PageIndexChanging">
                                <AlternatingRowStyle BackColor="Transparent" ForeColor="Black" Font-Size="Medium" />
                                <EditRowStyle BackColor="Transparent" Font-Size="Medium" />
                                <FooterStyle BackColor="Transparent" Font-Bold="True" ForeColor="White" Font-Size="Small" />
                                <HeaderStyle BackColor="#EB6534" Font-Bold="True" HorizontalAlign="Center" ForeColor="Black" Font-Size="Medium" Width="10%" />
                        ...
                        <div class="row text-center">
                            <div class="col-md-offset-1 col-md-10" style="font-size: large;">
                                <asp:GridView ID="GridView5" CssClass="gridview" runat="server" Width="100%" CellPadding="4" ForeColor="#333333" BorderColor="Black" BorderWidth="2px" HorizontalAlign="Left" GridLines="Both" ShowHeaderWhenEmpty="false" AllowPaging="true" PageSize="100" OnPageIndexChanging="test_human_gridview_2_PageIndexChanging">
                                <AlternatingRowStyle BackColor="Transparent" ForeColor="Black" Font-Size="Medium" />
                                <EditRowStyle BackColor="Transparent" Font-Size="Medium" />
                                <FooterStyle BackColor="Transparent" Font-Bold="True" ForeColor="White" Font-Size="Small" />
                                <HeaderStyle BackColor="#EB6534" Font-Bold="True" HorizontalAlign="Center" ForeColor="Black" Font-Size="Medium" Width="10%" />
                    ...
                    <asp:View ID="common_pathogen_view" runat="server">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <table>
                                    <tr>
                                        <td>Provide Uniprot Accession Numbers(Example: Q99IB8 & Q8AZK7)</td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                        ...
                        <div class="row text-center">
                            <div class="col-md-offset-1 col-md-10" style="font-size: large;">
                                <table style="width: 100%">
                                    <asp:GridView CssClass="gridview" ID="common_pathogen_gridview" OnRowDataBound="common_pathogen_gridview_RowDataBound" runat="server" Width="100%" CellPadding="4" ForeColor="#333333" BorderColor="Black" BorderWidth="2px" HorizontalAlign="Left" GridLines="Both" ShowHeaderWhenEmpty="false" AllowPaging="true" PageSize="100" OnPageIndexChanging="common_pathogen_gridview_PageIndexChanging">
                                <AlternatingRowStyle BackColor="Transparent" ForeColor="Black" Font-Size="Medium" />
                                <EditRowStyle BackColor="Transparent" Font-Size="Medium" />
                                <FooterStyle BackColor="Transparent" Font-Bold="True" ForeColor="White" Font-Size="Small" />
                                <HeaderStyle BackColor="#EB6534" Font-Bold="True" HorizontalAlign="Center" ForeColor="Black" Font-Size="Medium" Width="10%" />
                        ...
                        <div class="row text-center">
                            <div class="col-md-offset-1 col-md-10" style="font-size: large;">
                                <table style="width: 100%">
                                    <asp:GridView ID="GridView7" CssClass="gridview" runat="server" Width="100%" CellPadding="4" ForeColor="#333333" BorderColor="Black" BorderWidth="2px" HorizontalAlign="Left" GridLines="Both" ShowHeaderWhenEmpty="false" AllowPaging="true" PageSize="100" OnPageIndexChanging="test_pathogen_gridview_2_PageIndexChanging">
                                <AlternatingRowStyle BackColor="Transparent" ForeColor="Black" Font-Size="Medium" />
                                <EditRowStyle BackColor="Transparent" Font-Size="Medium" />
                                <FooterStyle BackColor="Transparent" Font-Bold="True" ForeColor="White" Font-Size="Small" />
                                <HeaderStyle BackColor="#EB6534" Font-Bold="True" HorizontalAlign="Center" ForeColor="Black" Font-Size="Medium" Width="10%" />
...
diseases and then lists the following information:
                        ...
                        <b style="color: black;">
                            <h3>2. Pathogen Specific Interactions:</h3>
                        </b>The page displays a dropdown of 432 pathogens to
...
interact with.
                        ...
                        <br />
                        <b style="color: black;">
                            <h3>3. Protein Specific Interactions:</h3>
                        </b>The page lets us choose for proteins from either the
...
given protein occurs, for the data present in the database.
                        ...
                        <br />
                        <b style="color: black;">
                            <h3>4. Gene Ontologies:</h3>
                        </b>This page requires the user to select between human or pathogen
...
function and GO Id for all interactions present in the database.
                        ...
                        <br />
                        <b style="color: black;">
                            <h3>5. Interaction Detection Method:</h3>
                        </b>The page allows the user to list the interaction data
...
type for each reaction.
                        ...
                        <b style="color: black;">
                            <h3>6. Interactors:</h3>
                        </b>This page allows us to view all the interactors from the same as well as
